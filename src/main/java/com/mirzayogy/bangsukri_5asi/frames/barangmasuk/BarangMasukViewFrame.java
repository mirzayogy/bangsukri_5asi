...
public class BarangMasukViewFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        viewTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Tanggal", "Nama Pemasok", "Nama Karyawan"
            }
        ) {
        ...
        tahunComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua", "2023", "2022" }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cariTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        try {
            ...
            if(tahun.equals("Semua")){
                filter =  "WHERE K.nama_karyawan LIKE '%"+kataKunci+"%'";
            } else {
                filter =  "WHERE YEAR(BM.tanggal) = " + tahun +
                    " AND K.nama_karyawan LIKE '%"+kataKunci+"%'";
            }
            Connection koneksi = Basisdata.getConnection();
            String selectSQL = "SELECT BM.id, BM.tanggal, P.nama_pemasok, K.nama_karyawan " +
            ...
            while(resultSet.next()){
                ...
                row[2] = resultSet.getString("nama_pemasok");
                row[3] = resultSet.getString("nama_karyawan");                
                model.addRow(row);
            }
            koneksi.close();
...
//        f.setVisible(true);
        BarangMasukAddFrame b = new BarangMasukAddFrame();
        b.setVisible(true);
